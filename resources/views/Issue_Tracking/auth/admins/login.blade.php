...
<head>
  ...
  <link rel="stylesheet" href="{{url('/')}}/frontend_plugins/css/bootstrap/bootstrap.min.css">
    <!-- Font awesome -->
  <link rel="stylesheet" href="{{url('/')}}/frontend_plugins/css/font-awesome/fontawesome.min.csss">
  <!-- main css -->
...
<div class="login-box" style="padding: 80px">
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your jobs as admin |<a href="{{route('home')}}" target="_blank"><b>Home</a></p>
